...
quad = rb.rigidbody(pos,rotmb2e,ve+[0.1, 0, 0],omegab,mass,I)
...
# Test initial conditions on Vx
quad = rb.rigidbody_q(pos,q,ve+[0.1, 0, 0],omegab,mass,I)
...
quad = rb.rigidbody(pos,rotmb2e,ve+[0, 0.1, 0],omegab,mass,I)
...
# Test initial conditions on Vy
quad = rb.rigidbody_q(pos,q,ve+[0, 0.1, 0],omegab,mass,I)
...
quad = rb.rigidbody(pos,rotmb2e,ve+[0, 0, 0.1],omegab,mass,I)
...
# Test initial conditions on Vz
quad = rb.rigidbody_q(pos,q,ve+[0, 0, 0.1],omegab,mass,I)
...
quad = rb.rigidbody(pos,rotmb2e,ve,omegab+[0.1, 0, 0],mass,I)
...
# Test initial conditions on ox
quad = rb.rigidbody_q(pos,q,ve,omegab+[0.1, 0, 0],mass,I)
...
quad = rb.rigidbody(pos,rotmb2e,ve,omegab+[0, 0.1, 0],mass,I)
...
# Test initial conditions on oy
quad = rb.rigidbody_q(pos,q,ve,omegab+[0, 0.1, 0],mass,I)
...
quad = rb.rigidbody(pos,rotmb2e,ve,omegab+[0, 0, 0.1],mass,I)
...
# Test initial conditions on oz
quad = rb.rigidbody_q(pos,q,ve,omegab+[0, 0, 0.1],mass,I)
