...
class SPKF:
    ...
    def __init__(self,f,G,Q,x0,P0,spt,variant=0):
    ...
    def update(self,meas, h, _empty_, R, var=0):
        ...
        if (var == 0):
            ...
            self.P = self.P - K@(Cy+R)@np.transpose(K)
        else:
            ...
            self.P = IKH@self.P@IKH.transpose()+K@R@K.transpose() # Joseph Form
##########################################################
